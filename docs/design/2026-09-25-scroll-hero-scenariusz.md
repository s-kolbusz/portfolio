...
- Hero też się przypina: 1 ekran scrolla (`H` = postęp 0–1). Potem od razu
  zaczyna się przypięcie sceny sygnaturowej (`P`).
...
Te same etapy. Przypięcie hero ok. 0,6 ekranu (propozycja). Imię na telefonie
ma dwie linie, więc litery spływają z obu. Rozmycie zastępuje samo wygaszanie,
bo `filter: blur` na telefonie kosztuje.
...
1. **Tło (plan 1):** czy w hero mają dryfować rozmyte kadry realizacji (~0.3×),
   jak w decyzjach redesignu? Dają głębię przy przeostrzeniu, ale dokładają treści.
2. **Długość przypięcia hero:** 1 ekran (propozycja) czy krócej?
   Razem ze sceną sygnaturową to 3,5 ekranu do uformowanej realizacji.
3. **Przekazanie:** scena sygnaturowa startuje z pełnego kadru materii
   (cofanie się do 16:9), a nie z koła. To zmienia pierwszy etap tamtej sceny.
